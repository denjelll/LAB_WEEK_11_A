...
// Import yang diperlukan untuk DataStore
...
// Catatan: DataStore harus bertipe DataStore<Preferences>
...
class SettingsStore(private val context: Context) {
    ...
    val text: Flow<String> = context.dataStore.data
        .map { preferences ->
            // Mengambil nilai String dari key yang disimpan, jika kosong/null, default-nya adalah ""
            preferences[KEY_TEXT] ?: ""
        }

    // Save the text to the data store
    suspend fun saveText(text: String) {
        // Fungsi edit digunakan untuk menulis data secara aman dan asinkron
    ...
    companion object {
        // stringPreferencesKey memastikan nilai yang disimpan/diambil bertipe String
